...
<input type="submit" name="submit" value="Register" style="width: 122px; background: white; color: black; border: #800000; height: 31px; font-family: 'Georgia', 'Arial Narrow', Arial, sans-serif" /> </div>
</form>
