...
<tr>
  ...
  <tr>
   ...
   <td><input type="password" name="confirmnewpassword" id="confirmnewpassword"></td><br><br>
        ...
        <input name="Update" type="submit" value="Update" style="background:white; border: #800000; width: 150px; color: black; height: 36px; font-family: 'Georgia', 'Arial Narrow', Arial, sans-serif; text-decoration: none; text-transform: capitalize; font-style: normal; font-size: small; font-weight: bold;"/>
    </form>
   </div>
   </body>
   </html>