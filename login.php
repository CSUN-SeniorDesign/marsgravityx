...
<h5>Password:</h5>&nbsp;<input type="password" name="password" id="password" placeholder="Password" class="auto-style6" style="width: 328px; height: 30px;" /><br>
	<br>
<input name="submit" type="submit" value="Login" style="background:white; border: #800000; width: 150px; color: black; height: 36px; font-family: 'Georgia', 'Arial Narrow', Arial, sans-serif; text-decoration: none; text-transform: capitalize; font-style: normal; font-size: small; font-weight: bold;" />
	<br>
	<br>
</form>
<br>	
